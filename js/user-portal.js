...
function initDashboard() {
  ...
  const totalCountries = [...new Set(allDests.map(d => d.country))].length;
  ...
  if (destCountEl) destCountEl.textContent = totalDests;
  if (countryCountEl) countryCountEl.textContent = totalCountries;
