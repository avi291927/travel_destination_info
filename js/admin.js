    ...
    <tr>
      <td>
        <div style="display:flex;align-items:center;gap:10px">
          <img src="${getImageUrl(dest.image)}" alt="${dest.name}" class="table-thumbnail" onerror="this.src='https://images.unsplash.com/photo-1488085061387-422e29b40080?w=200&q=60'" />
