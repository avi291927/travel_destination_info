...
const ADMIN_CREDENTIALS = { email: 'admin@wander.com', password: 'admin123' };
...
function demoLogin(type) {
  ...
  const demoEmail = 'demo@wanderworld.com';
  let user = DataManager.getUserByEmail(demoEmail);
  if (!user) {
